...
export default function AboutMeContentFile() {
  ...
  return (
    ...
    <div>
    <div className='bioHeader' onClick={pastCareerToggle} id='togglePastCareer'>My Past Career</div>
    <div className='bioContent' id='pastCareerContent'>In my previous career, I taught high school music.</div>
    <div className='bioHeader' onClick={journeyToggle} id='toggleJourney'>My Coding Journey</div>
    ...
    <div className='bioHeader' onClick={futurePlansToggle} id='toggleFuturePlans'>My Future Plans</div>
